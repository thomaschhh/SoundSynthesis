 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec130[0] = (fSlow65 + (0.999000013f * fRec130[1]));
			iRec131[0] = ((1103515245 * iRec131[1]) + 12345);
			fRec133[0] = (fSlow66 + (0.999000013f * fRec133[1]));
			float fTemp225 = (fRec132[1] + (fConst2 * fRec133[0]));
			fRec132[0] = (fTemp225 - std::floor(fTemp225));
			fRec134[0] = (fSlow67 + (0.999000013f * fRec134[1]));
			...
			fRec129[0] = ((1.86264515e-09f * ((fRec130[0] * float(iRec131[0])) * ((2.0f * fRec132[0]) + -1.0f))) - (((fRec129[2] * (((fTemp227 + -1.84775901f) / fTemp226) + 1.0f)) + (2.0f * (fRec129[1] * fTemp228))) / fTemp229));
