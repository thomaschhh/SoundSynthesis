...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("filename", "BASIS_pulse.1.tmp.dsp");
		...
		m->declare("name", "BASIS_pulse.1.tmp");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("BASIS_pulse.1.tmp");
		...
		ui_interface->addNumEntry("cutoff", &fEntry2, 500.0f, 60.0f, 1000.0f, 1.0f);
		ui_interface->closeBox();
		...
		ui_interface->declare(&fVslider2, "scale", "exp");
		...
		ui_interface->addNumEntry("cutoff", &fEntry5, 500.0f, 60.0f, 1000.0f, 1.0f);
		ui_interface->closeBox();
		...
		ui_interface->declare(&fEntry8, "3", "");
		ui_interface->declare(&fEntry8, "style", "knob");
		ui_interface->addNumEntry("cutoff", &fEntry8, 500.0f, 60.0f, 1000.0f, 1.0f);
		ui_interface->closeBox();
		...
		ui_interface->declare(&fVslider4, "scale", "exp");
		ui_interface->addVerticalSlider("gain", &fVslider4, 0.0f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->declare(&fEntry11, "3", "");
		ui_interface->declare(&fEntry11, "style", "knob");
		ui_interface->addNumEntry("cutoff", &fEntry11, 500.0f, 60.0f, 1000.0f, 1.0f);
		ui_interface->closeBox();
		...
		ui_interface->declare(&fEntry14, "3", "");
		ui_interface->declare(&fEntry14, "style", "knob");
		ui_interface->addNumEntry("cutoff", &fEntry14, 500.0f, 60.0f, 1000.0f, 1.0f);
		ui_interface->closeBox();
		...
		ui_interface->addNumEntry("duty", &fEntry16, 0.5f, 0.00100000005f, 0.999000013f, 0.00100000005f);
		ui_interface->declare(&fEntry15, "1", "");
		...
		ui_interface->declare(&fVslider6, "scale", "exp");
		ui_interface->addVerticalSlider("gain", &fVslider6, 0.0f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->declare(&fEntry17, "3", "");
		ui_interface->declare(&fEntry17, "style", "knob");
		ui_interface->addNumEntry("cutoff", &fEntry17, 500.0f, 60.0f, 1000.0f, 1.0f);
		ui_interface->closeBox();
		...
		ui_interface->addNumEntry("cutoff", &fEntry20, 500.0f, 60.0f, 1000.0f, 1.0f);
		ui_interface->closeBox();
		ui_interface->declare(0, "17", "");
		ui_interface->openVerticalBox("BL7");
		ui_interface->declare(&fEntry22, "0", "");
		ui_interface->declare(&fEntry22, "style", "knob");
		ui_interface->addNumEntry("duty", &fEntry22, 0.5f, 0.00100000005f, 0.999000013f, 0.00100000005f);
		ui_interface->declare(&fEntry21, "1", "");
		ui_interface->declare(&fEntry21, "style", "knob");
		ui_interface->addNumEntry("freq", &fEntry21, 200.0f, 60.0f, 1000.0f, 0.00999999978f);
		ui_interface->declare(&fVslider8, "2", "");
		ui_interface->declare(&fVslider8, "scale", "exp");
		...
		ui_interface->addNumEntry("cutoff", &fEntry23, 500.0f, 60.0f, 1000.0f, 1.0f);
		ui_interface->closeBox();
		...
		ui_interface->declare(&fEntry26, "3", "");
		ui_interface->declare(&fEntry26, "style", "knob");
		ui_interface->addNumEntry("cutoff", &fEntry26, 500.0f, 60.0f, 1000.0f, 1.0f);
		ui_interface->closeBox();
		...
		ui_interface->addNumEntry("duty", &fEntry28, 0.5f, 0.00100000005f, 0.999000013f, 0.00100000005f);
		...
		ui_interface->declare(&fVslider10, "scale", "exp");
		ui_interface->addVerticalSlider("gain", &fVslider10, 0.0f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->declare(&fEntry29, "3", "");
		ui_interface->declare(&fEntry29, "style", "knob");
		ui_interface->addNumEntry("cutoff", &fEntry29, 500.0f, 60.0f, 1000.0f, 1.0f);
		ui_interface->closeBox();
		...
		ui_interface->declare(&fEntry32, "3", "");
		ui_interface->declare(&fEntry32, "style", "knob");
		ui_interface->addNumEntry("cutoff", &fEntry32, 500.0f, 60.0f, 1000.0f, 1.0f);
		ui_interface->closeBox();
		...
		ui_interface->addNumEntry("duty", &fEntry34, 0.5f, 0.00100000005f, 0.999000013f, 0.00100000005f);
		ui_interface->declare(&fEntry33, "1", "");
		ui_interface->declare(&fEntry33, "style", "knob");
		ui_interface->addNumEntry("freq", &fEntry33, 200.0f, 60.0f, 1000.0f, 0.00999999978f);
		ui_interface->declare(&fVslider12, "2", "");
		ui_interface->declare(&fVslider12, "scale", "exp");
		ui_interface->addVerticalSlider("gain", &fVslider12, 0.0f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->declare(&fEntry35, "3", "");
		ui_interface->declare(&fEntry35, "style", "knob");
		ui_interface->addNumEntry("cutoff", &fEntry35, 500.0f, 60.0f, 1000.0f, 1.0f);
		ui_interface->closeBox();
		...
		ui_interface->addNumEntry("duty", &fEntry37, 0.5f, 0.00100000005f, 0.999000013f, 0.00100000005f);
		ui_interface->declare(&fEntry36, "1", "");
		ui_interface->declare(&fEntry36, "style", "knob");
		ui_interface->addNumEntry("freq", &fEntry36, 200.0f, 60.0f, 1000.0f, 0.00999999978f);
		...
		ui_interface->declare(&fEntry38, "3", "");
		ui_interface->declare(&fEntry38, "style", "knob");
		ui_interface->addNumEntry("cutoff", &fEntry38, 500.0f, 60.0f, 1000.0f, 1.0f);
		ui_interface->closeBox();
		ui_interface->declare(0, "23", "");
		ui_interface->openVerticalBox("BL13");
		ui_interface->declare(&fEntry40, "0", "");
		ui_interface->declare(&fEntry40, "style", "knob");
		ui_interface->addNumEntry("duty", &fEntry40, 0.5f, 0.00100000005f, 0.999000013f, 0.00100000005f);
		ui_interface->declare(&fEntry39, "1", "");
		ui_interface->declare(&fEntry39, "style", "knob");
		ui_interface->addNumEntry("freq", &fEntry39, 200.0f, 60.0f, 1000.0f, 0.00999999978f);
		ui_interface->declare(&fVslider14, "2", "");
		ui_interface->declare(&fVslider14, "scale", "exp");
		...
		ui_interface->addNumEntry("cutoff", &fEntry41, 500.0f, 60.0f, 1000.0f, 1.0f);
		ui_interface->closeBox();
		...
		ui_interface->addNumEntry("duty", &fEntry43, 0.5f, 0.00100000005f, 0.999000013f, 0.00100000005f);
		ui_interface->declare(&fEntry42, "1", "");
		ui_interface->declare(&fEntry42, "style", "knob");
		ui_interface->addNumEntry("freq", &fEntry42, 200.0f, 60.0f, 1000.0f, 0.00999999978f);
		...
		ui_interface->declare(&fEntry44, "3", "");
		ui_interface->declare(&fEntry44, "style", "knob");
		ui_interface->addNumEntry("cutoff", &fEntry44, 500.0f, 60.0f, 1000.0f, 1.0f);
		ui_interface->closeBox();
		...
		ui_interface->declare(&fVslider16, "scale", "exp");
		...
		ui_interface->addNumEntry("cutoff", &fEntry47, 500.0f, 60.0f, 1000.0f, 1.0f);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow4 = (0.00100000005f * float(fEntry2));
		float fSlow5 = (0.00100000005f * float(fVslider2));
		...
		float fSlow10 = (0.00100000005f * float(fEntry6));
		float fSlow11 = (0.00100000005f * float(fEntry7));
		float fSlow12 = (0.00100000005f * float(fEntry8));
		float fSlow13 = (0.00100000005f * float(fVslider4));
		float fSlow14 = (0.00100000005f * float(fEntry9));
		float fSlow15 = (0.00100000005f * float(fEntry10));
		float fSlow16 = (0.00100000005f * float(fEntry11));
		float fSlow17 = (0.00100000005f * float(fVslider5));
		float fSlow18 = (0.00100000005f * float(fEntry12));
		float fSlow19 = (0.00100000005f * float(fEntry13));
		float fSlow20 = (0.00100000005f * float(fEntry14));
		float fSlow21 = (0.00100000005f * float(fVslider6));
		float fSlow22 = (0.00100000005f * float(fEntry15));
		float fSlow23 = (0.00100000005f * float(fEntry16));
		float fSlow24 = (0.00100000005f * float(fEntry17));
		float fSlow25 = (0.00100000005f * float(fVslider7));
		float fSlow26 = (0.00100000005f * float(fEntry18));
		float fSlow27 = (0.00100000005f * float(fEntry19));
		float fSlow28 = (0.00100000005f * float(fEntry20));
		float fSlow29 = (0.00100000005f * float(fVslider8));
		float fSlow30 = (0.00100000005f * float(fEntry21));
		float fSlow31 = (0.00100000005f * float(fEntry22));
		float fSlow32 = (0.00100000005f * float(fEntry23));
		float fSlow33 = (0.00100000005f * float(fVslider9));
		float fSlow34 = (0.00100000005f * float(fEntry24));
		float fSlow35 = (0.00100000005f * float(fEntry25));
		float fSlow36 = (0.00100000005f * float(fEntry26));
		float fSlow37 = (0.00100000005f * float(fVslider10));
		float fSlow38 = (0.00100000005f * float(fEntry27));
		float fSlow39 = (0.00100000005f * float(fEntry28));
		float fSlow40 = (0.00100000005f * float(fEntry29));
		float fSlow41 = (0.00100000005f * float(fVslider11));
		float fSlow42 = (0.00100000005f * float(fEntry30));
		float fSlow43 = (0.00100000005f * float(fEntry31));
		float fSlow44 = (0.00100000005f * float(fEntry32));
		float fSlow45 = (0.00100000005f * float(fVslider12));
		float fSlow46 = (0.00100000005f * float(fEntry33));
		float fSlow47 = (0.00100000005f * float(fEntry34));
		float fSlow48 = (0.00100000005f * float(fEntry35));
		float fSlow49 = (0.00100000005f * float(fVslider13));
		float fSlow50 = (0.00100000005f * float(fEntry36));
		float fSlow51 = (0.00100000005f * float(fEntry37));
		float fSlow52 = (0.00100000005f * float(fEntry38));
		float fSlow53 = (0.00100000005f * float(fVslider14));
		float fSlow54 = (0.00100000005f * float(fEntry39));
		float fSlow55 = (0.00100000005f * float(fEntry40));
		float fSlow56 = (0.00100000005f * float(fEntry41));
		float fSlow57 = (0.00100000005f * float(fVslider15));
		float fSlow58 = (0.00100000005f * float(fEntry42));
		float fSlow59 = (0.00100000005f * float(fEntry43));
		float fSlow60 = (0.00100000005f * float(fEntry44));
		float fSlow61 = (0.00100000005f * float(fVslider16));
		float fSlow62 = (0.00100000005f * float(fEntry45));
		float fSlow63 = (0.00100000005f * float(fEntry46));
		float fSlow64 = (0.00100000005f * float(fEntry47));
		float fSlow65 = (0.00100000005f * float(fVslider17));
		float fSlow66 = (0.00100000005f * float(fVslider18));
		float fSlow67 = (0.00100000005f * float(fVslider19));
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec3[0] = ((fConst1 * ((fTemp5 - (fVec3[((IOTA - iTemp7) & 4095)] * (fTemp8 + (1.0f - fTemp6)))) - ((fTemp6 - fTemp8) * fVec3[((IOTA - (iTemp7 + 1)) & 4095)]))) - (((fRec3[2] * (((fTemp10 + -1.93185163f) / fTemp9) + 1.0f)) + (2.0f * (fRec3[1] * fTemp11))) / fTemp12));
			...
			fRec11[0] = ((fConst1 * ((fTemp19 - (fVec6[((IOTA - iTemp21) & 4095)] * (fTemp22 + (1.0f - fTemp20)))) - ((fTemp20 - fTemp22) * fVec6[((IOTA - (iTemp21 + 1)) & 4095)]))) - (((fRec11[2] * (((fTemp24 + -1.93185163f) / fTemp23) + 1.0f)) + (2.0f * (fRec11[1] * fTemp25))) / fTemp26));
			...
			fRec19[0] = ((fConst1 * ((fTemp33 - (fVec9[((IOTA - iTemp35) & 4095)] * (fTemp36 + (1.0f - fTemp34)))) - ((fTemp34 - fTemp36) * fVec9[((IOTA - (iTemp35 + 1)) & 4095)]))) - (((fRec19[2] * (((fTemp38 + -1.93185163f) / fTemp37) + 1.0f)) + (2.0f * (fRec19[1] * fTemp39))) / fTemp40));
			...
			fRec27[0] = ((fConst1 * ((fTemp47 - (fVec12[((IOTA - iTemp49) & 4095)] * (fTemp50 + (1.0f - fTemp48)))) - ((fTemp48 - fTemp50) * fVec12[((IOTA - (iTemp49 + 1)) & 4095)]))) - (((fRec27[2] * (((fTemp52 + -1.93185163f) / fTemp51) + 1.0f)) + (2.0f * (fRec27[1] * fTemp53))) / fTemp54));
			...
			fRec35[0] = ((fConst1 * ((fTemp61 - (fVec15[((IOTA - iTemp63) & 4095)] * (fTemp64 + (1.0f - fTemp62)))) - ((fTemp62 - fTemp64) * fVec15[((IOTA - (iTemp63 + 1)) & 4095)]))) - (((fRec35[2] * (((fTemp66 + -1.93185163f) / fTemp65) + 1.0f)) + (2.0f * (fRec35[1] * fTemp67))) / fTemp68));
			...
			fRec43[0] = ((fConst1 * ((fTemp75 - (fVec18[((IOTA - iTemp77) & 4095)] * (fTemp78 + (1.0f - fTemp76)))) - ((fTemp76 - fTemp78) * fVec18[((IOTA - (iTemp77 + 1)) & 4095)]))) - (((fRec43[2] * (((fTemp80 + -1.93185163f) / fTemp79) + 1.0f)) + (2.0f * (fRec43[1] * fTemp81))) / fTemp82));
			...
			fRec51[0] = ((fConst1 * ((fTemp89 - (fVec21[((IOTA - iTemp91) & 4095)] * (fTemp92 + (1.0f - fTemp90)))) - ((fTemp90 - fTemp92) * fVec21[((IOTA - (iTemp91 + 1)) & 4095)]))) - (((fRec51[2] * (((fTemp94 + -1.93185163f) / fTemp93) + 1.0f)) + (2.0f * (fRec51[1] * fTemp95))) / fTemp96));
			...
			fRec59[0] = ((fConst1 * ((fTemp103 - (fVec24[((IOTA - iTemp105) & 4095)] * (fTemp106 + (1.0f - fTemp104)))) - ((fTemp104 - fTemp106) * fVec24[((IOTA - (iTemp105 + 1)) & 4095)]))) - (((fRec59[2] * (((fTemp108 + -1.93185163f) / fTemp107) + 1.0f)) + (2.0f * (fRec59[1] * fTemp109))) / fTemp110));
			...
			fRec67[0] = ((fConst1 * ((fTemp117 - (fVec27[((IOTA - iTemp119) & 4095)] * (fTemp120 + (1.0f - fTemp118)))) - ((fTemp118 - fTemp120) * fVec27[((IOTA - (iTemp119 + 1)) & 4095)]))) - (((fRec67[2] * (((fTemp122 + -1.93185163f) / fTemp121) + 1.0f)) + (2.0f * (fRec67[1] * fTemp123))) / fTemp124));
			...
			fRec75[0] = ((fConst1 * ((fTemp131 - (fVec30[((IOTA - iTemp133) & 4095)] * (fTemp134 + (1.0f - fTemp132)))) - ((fTemp132 - fTemp134) * fVec30[((IOTA - (iTemp133 + 1)) & 4095)]))) - (((fRec75[2] * (((fTemp136 + -1.93185163f) / fTemp135) + 1.0f)) + (2.0f * (fRec75[1] * fTemp137))) / fTemp138));
			...
			fRec83[0] = ((fConst1 * ((fTemp145 - (fVec33[((IOTA - iTemp147) & 4095)] * (fTemp148 + (1.0f - fTemp146)))) - ((fTemp146 - fTemp148) * fVec33[((IOTA - (iTemp147 + 1)) & 4095)]))) - (((fRec83[2] * (((fTemp150 + -1.93185163f) / fTemp149) + 1.0f)) + (2.0f * (fRec83[1] * fTemp151))) / fTemp152));
			...
			fRec91[0] = ((fConst1 * ((fTemp159 - (fVec36[((IOTA - iTemp161) & 4095)] * (fTemp162 + (1.0f - fTemp160)))) - ((fTemp160 - fTemp162) * fVec36[((IOTA - (iTemp161 + 1)) & 4095)]))) - (((fRec91[2] * (((fTemp164 + -1.93185163f) / fTemp163) + 1.0f)) + (2.0f * (fRec91[1] * fTemp165))) / fTemp166));
			...
			fRec99[0] = ((fConst1 * ((fTemp173 - (fVec39[((IOTA - iTemp175) & 4095)] * (fTemp176 + (1.0f - fTemp174)))) - ((fTemp174 - fTemp176) * fVec39[((IOTA - (iTemp175 + 1)) & 4095)]))) - (((fRec99[2] * (((fTemp178 + -1.93185163f) / fTemp177) + 1.0f)) + (2.0f * (fRec99[1] * fTemp179))) / fTemp180));
			...
			fRec107[0] = ((fConst1 * ((fTemp187 - (fVec42[((IOTA - iTemp189) & 4095)] * (fTemp190 + (1.0f - fTemp188)))) - ((fTemp188 - fTemp190) * fVec42[((IOTA - (iTemp189 + 1)) & 4095)]))) - (((fRec107[2] * (((fTemp192 + -1.93185163f) / fTemp191) + 1.0f)) + (2.0f * (fRec107[1] * fTemp193))) / fTemp194));
			...
			fRec115[0] = ((fConst1 * ((fTemp201 - (fVec45[((IOTA - iTemp203) & 4095)] * (fTemp204 + (1.0f - fTemp202)))) - ((fTemp202 - fTemp204) * fVec45[((IOTA - (iTemp203 + 1)) & 4095)]))) - (((fRec115[2] * (((fTemp206 + -1.93185163f) / fTemp205) + 1.0f)) + (2.0f * (fRec115[1] * fTemp207))) / fTemp208));
			...
			fRec123[0] = ((fConst1 * ((fTemp215 - (fVec48[((IOTA - iTemp217) & 4095)] * (fTemp218 + (1.0f - fTemp216)))) - ((fTemp216 - fTemp218) * fVec48[((IOTA - (iTemp217 + 1)) & 4095)]))) - (((fRec123[2] * (((fTemp220 + -1.93185163f) / fTemp219) + 1.0f)) + (2.0f * (fRec123[1] * fTemp221))) / fTemp222));
			...
			float fTemp225 = (fRec133[1] + (fConst2 * fRec134[1]));
