...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("gain", &fVslider0, 0.0f, 0.0f, 1.0f, 0.00100000005f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow13 = (0.00100000005f * float(fVslider6));
		float fSlow14 = (0.00100000005f * float(fEntry6));
		float fSlow15 = (0.00100000005f * float(fVslider7));
		float fSlow16 = (0.00100000005f * float(fEntry7));
		float fSlow17 = (0.00100000005f * float(fVslider8));
		float fSlow18 = (0.00100000005f * float(fEntry8));
		float fSlow19 = (0.00100000005f * float(fVslider9));
		...
		float fSlow23 = (0.00100000005f * float(fVslider11));
		float fSlow24 = (0.00100000005f * float(fEntry11));
		float fSlow25 = (0.00100000005f * float(fVslider12));
		float fSlow26 = (0.00100000005f * float(fEntry12));
		float fSlow27 = (0.00100000005f * float(fVslider13));
		float fSlow28 = (0.00100000005f * float(fEntry13));
		float fSlow29 = (0.00100000005f * float(fVslider14));
		float fSlow30 = (0.00100000005f * float(fEntry14));
		float fSlow31 = (0.00100000005f * float(fVslider15));
