...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "BASIS.1.tmp.dsp");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("BASIS.1.tmp");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp0 = (fRec5[1] + (fConst1 * fRec6[0]));
			fRec5[0] = (fTemp0 - std::floor(fTemp0));
			fRec7[0] = (fSlow3 + (0.999000013f * fRec7[1]));
			fRec9[0] = (fSlow4 + (0.999000013f * fRec9[1]));
			float fTemp1 = (fRec8[1] + (fConst1 * fRec9[0]));
			fRec8[0] = (fTemp1 - std::floor(fTemp1));
			fRec10[0] = (fSlow5 + (0.999000013f * fRec10[1]));
			fRec12[0] = (fSlow6 + (0.999000013f * fRec12[1]));
			float fTemp2 = (fRec11[1] + (fConst1 * fRec12[0]));
			fRec11[0] = (fTemp2 - std::floor(fTemp2));
			fRec13[0] = (fSlow7 + (0.999000013f * fRec13[1]));
			fRec15[0] = (fSlow8 + (0.999000013f * fRec15[1]));
			float fTemp3 = (fRec14[1] + (fConst1 * fRec15[0]));
			fRec14[0] = (fTemp3 - std::floor(fTemp3));
			fRec16[0] = (fSlow9 + (0.999000013f * fRec16[1]));
			fRec18[0] = (fSlow10 + (0.999000013f * fRec18[1]));
			float fTemp4 = (fRec17[1] + (fConst1 * fRec18[0]));
			fRec17[0] = (fTemp4 - std::floor(fTemp4));
			fRec19[0] = (fSlow11 + (0.999000013f * fRec19[1]));
			fRec21[0] = (fSlow12 + (0.999000013f * fRec21[1]));
			float fTemp5 = (fRec20[1] + (fConst1 * fRec21[0]));
			fRec20[0] = (fTemp5 - std::floor(fTemp5));
			fRec22[0] = (fSlow13 + (0.999000013f * fRec22[1]));
			fRec24[0] = (fSlow14 + (0.999000013f * fRec24[1]));
			float fTemp6 = (fRec23[1] + (fConst1 * fRec24[0]));
			fRec23[0] = (fTemp6 - std::floor(fTemp6));
			fRec25[0] = (fSlow15 + (0.999000013f * fRec25[1]));
			fRec27[0] = (fSlow16 + (0.999000013f * fRec27[1]));
			float fTemp7 = (fRec26[1] + (fConst1 * fRec27[0]));
			fRec26[0] = (fTemp7 - std::floor(fTemp7));
			fRec28[0] = (fSlow17 + (0.999000013f * fRec28[1]));
			fRec30[0] = (fSlow18 + (0.999000013f * fRec30[1]));
			float fTemp8 = (fRec29[1] + (fConst1 * fRec30[0]));
			fRec29[0] = (fTemp8 - std::floor(fTemp8));
			fRec31[0] = (fSlow19 + (0.999000013f * fRec31[1]));
			fRec33[0] = (fSlow20 + (0.999000013f * fRec33[1]));
			float fTemp9 = (fRec32[1] + (fConst1 * fRec33[0]));
			fRec32[0] = (fTemp9 - std::floor(fTemp9));
			fRec34[0] = (fSlow21 + (0.999000013f * fRec34[1]));
			fRec36[0] = (fSlow22 + (0.999000013f * fRec36[1]));
			float fTemp10 = (fRec35[1] + (fConst1 * fRec36[0]));
			fRec35[0] = (fTemp10 - std::floor(fTemp10));
			fRec37[0] = (fSlow23 + (0.999000013f * fRec37[1]));
			fRec39[0] = (fSlow24 + (0.999000013f * fRec39[1]));
			float fTemp11 = (fRec38[1] + (fConst1 * fRec39[0]));
			fRec38[0] = (fTemp11 - std::floor(fTemp11));
			fRec40[0] = (fSlow25 + (0.999000013f * fRec40[1]));
			fRec42[0] = (fSlow26 + (0.999000013f * fRec42[1]));
			float fTemp12 = (fRec41[1] + (fConst1 * fRec42[0]));
			fRec41[0] = (fTemp12 - std::floor(fTemp12));
			fRec43[0] = (fSlow27 + (0.999000013f * fRec43[1]));
			fRec45[0] = (fSlow28 + (0.999000013f * fRec45[1]));
			float fTemp13 = (fRec44[1] + (fConst1 * fRec45[0]));
			fRec44[0] = (fTemp13 - std::floor(fTemp13));
			fRec46[0] = (fSlow29 + (0.999000013f * fRec46[1]));
			fRec48[0] = (fSlow30 + (0.999000013f * fRec48[1]));
			float fTemp14 = (fRec47[1] + (fConst1 * fRec48[0]));
			fRec47[0] = (fTemp14 - std::floor(fTemp14));
			fRec49[0] = (fSlow31 + (0.999000013f * fRec49[1]));
			fRec51[0] = (fSlow32 + (0.999000013f * fRec51[1]));
			float fTemp15 = (fRec50[1] + (fConst1 * fRec51[0]));
			fRec50[0] = (fTemp15 - std::floor(fTemp15));
			fRec52[0] = (fSlow33 + (0.999000013f * fRec52[1]));
			iRec53[0] = ((1103515245 * iRec53[1]) + 12345);
			fRec55[0] = (fSlow34 + (0.999000013f * fRec55[1]));
			float fTemp16 = (fRec54[1] + (fConst1 * fRec55[1]));
