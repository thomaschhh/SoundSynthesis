...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addNumEntry("duty", &fEntry2, 0.5f, 0.00100000005f, 0.999000013f, 0.00100000005f);
		...
		ui_interface->addNumEntry("pan", &fEntry3, 0.5f, 0.0f, 1.0f, 0.00100000005f);
		...
		ui_interface->addNumEntry("pan", &fEntry6, 0.5f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->declare(&fEntry8, "1", "");
		ui_interface->declare(&fEntry8, "style", "knob");
		ui_interface->addNumEntry("duty", &fEntry8, 0.5f, 0.00100000005f, 0.999000013f, 0.00100000005f);
		ui_interface->declare(&fEntry7, "2", "");
		...
		ui_interface->addNumEntry("pan", &fEntry9, 0.5f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->declare(&fEntry11, "1", "");
		...
		ui_interface->addNumEntry("pan", &fEntry12, 0.5f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->declare(&fEntry14, "1", "");
		ui_interface->declare(&fEntry14, "style", "knob");
		ui_interface->addNumEntry("duty", &fEntry14, 0.5f, 0.00100000005f, 0.999000013f, 0.00100000005f);
		ui_interface->declare(&fEntry13, "2", "");
		...
		ui_interface->addNumEntry("pan", &fEntry15, 0.5f, 0.0f, 1.0f, 0.00100000005f);
		...
		ui_interface->addNumEntry("pan", &fEntry18, 0.5f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->declare(&fEntry20, "1", "");
		ui_interface->declare(&fEntry20, "style", "knob");
		ui_interface->addNumEntry("duty", &fEntry20, 0.5f, 0.00100000005f, 0.999000013f, 0.00100000005f);
		...
		ui_interface->declare(&fEntry23, "1", "");
		...
		ui_interface->addNumEntry("pan", &fEntry24, 0.5f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->declare(&fEntry26, "1", "");
		ui_interface->declare(&fEntry26, "style", "knob");
		ui_interface->addNumEntry("duty", &fEntry26, 0.5f, 0.00100000005f, 0.999000013f, 0.00100000005f);
		ui_interface->declare(&fEntry25, "2", "");
		ui_interface->declare(&fEntry25, "style", "knob");
		ui_interface->addNumEntry("freq", &fEntry25, 200.0f, 60.0f, 1000.0f, 0.00999999978f);
		...
		ui_interface->addNumEntry("pan", &fEntry27, 0.5f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->declare(&fEntry29, "1", "");
		...
		ui_interface->addNumEntry("pan", &fEntry30, 0.5f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->declare(&fEntry32, "1", "");
		...
		ui_interface->declare(&fEntry33, "0", "");
		ui_interface->declare(&fEntry33, "style", "knob");
		ui_interface->addNumEntry("pan", &fEntry33, 0.5f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->declare(&fEntry35, "1", "");
		ui_interface->declare(&fEntry35, "style", "knob");
		ui_interface->addNumEntry("duty", &fEntry35, 0.5f, 0.00100000005f, 0.999000013f, 0.00100000005f);
		ui_interface->declare(&fEntry34, "2", "");
		ui_interface->declare(&fEntry34, "style", "knob");
		ui_interface->addNumEntry("freq", &fEntry34, 200.0f, 60.0f, 1000.0f, 0.00999999978f);
		...
		ui_interface->declare(&fEntry36, "0", "");
		ui_interface->declare(&fEntry36, "style", "knob");
		ui_interface->addNumEntry("pan", &fEntry36, 0.5f, 0.0f, 1.0f, 0.00100000005f);
		...
		ui_interface->addNumEntry("pan", &fEntry39, 0.5f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->declare(&fEntry41, "1", "");
		ui_interface->declare(&fEntry41, "style", "knob");
		ui_interface->addNumEntry("duty", &fEntry41, 0.5f, 0.00100000005f, 0.999000013f, 0.00100000005f);
		ui_interface->declare(&fEntry40, "2", "");
		ui_interface->declare(&fEntry40, "style", "knob");
		ui_interface->addNumEntry("freq", &fEntry40, 200.0f, 60.0f, 1000.0f, 0.00999999978f);
		...
		ui_interface->declare(&fEntry44, "1", "");
		ui_interface->declare(&fEntry44, "style", "knob");
		ui_interface->addNumEntry("duty", &fEntry44, 0.5f, 0.00100000005f, 0.999000013f, 0.00100000005f);
		ui_interface->declare(&fEntry43, "2", "");
		...
		ui_interface->addNumEntry("pan", &fEntry45, 0.5f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->declare(&fEntry47, "1", "");
		ui_interface->declare(&fEntry47, "style", "knob");
		ui_interface->addNumEntry("duty", &fEntry47, 0.5f, 0.00100000005f, 0.999000013f, 0.00100000005f);
		ui_interface->declare(&fEntry46, "2", "");
		ui_interface->declare(&fEntry46, "style", "knob");
		ui_interface->addNumEntry("freq", &fEntry46, 200.0f, 60.0f, 1000.0f, 0.00999999978f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow8 = (0.00100000005f * float(fVslider3));
		float fSlow9 = (0.00100000005f * float(fEntry3));
		float fSlow10 = (0.00100000005f * float(fEntry4));
		float fSlow11 = (0.00100000005f * float(fEntry5));
		float fSlow12 = (0.00100000005f * float(fVslider4));
		float fSlow13 = (1.0f - float(fCheckbox2));
		float fSlow14 = (0.00100000005f * float(fVslider5));
		float fSlow15 = (0.00100000005f * float(fEntry6));
		float fSlow16 = (0.00100000005f * float(fEntry7));
		float fSlow17 = (0.00100000005f * float(fEntry8));
		float fSlow18 = (0.00100000005f * float(fVslider6));
		float fSlow19 = (1.0f - float(fCheckbox3));
		float fSlow20 = (0.00100000005f * float(fVslider7));
		float fSlow21 = (0.00100000005f * float(fEntry9));
		float fSlow22 = (0.00100000005f * float(fEntry10));
		float fSlow23 = (0.00100000005f * float(fEntry11));
		float fSlow24 = (0.00100000005f * float(fVslider8));
		float fSlow25 = (1.0f - float(fCheckbox4));
		float fSlow26 = (0.00100000005f * float(fVslider9));
		float fSlow27 = (0.00100000005f * float(fEntry12));
		float fSlow28 = (0.00100000005f * float(fEntry13));
		float fSlow29 = (0.00100000005f * float(fEntry14));
		float fSlow30 = (0.00100000005f * float(fVslider10));
		float fSlow31 = (1.0f - float(fCheckbox5));
		float fSlow32 = (0.00100000005f * float(fVslider11));
		float fSlow33 = (0.00100000005f * float(fEntry15));
		float fSlow34 = (0.00100000005f * float(fEntry16));
		float fSlow35 = (0.00100000005f * float(fEntry17));
		float fSlow36 = (0.00100000005f * float(fVslider12));
		float fSlow37 = (1.0f - float(fCheckbox6));
		float fSlow38 = (0.00100000005f * float(fVslider13));
		float fSlow39 = (0.00100000005f * float(fEntry18));
		float fSlow40 = (0.00100000005f * float(fEntry19));
		float fSlow41 = (0.00100000005f * float(fEntry20));
		float fSlow42 = (0.00100000005f * float(fVslider14));
		float fSlow43 = (1.0f - float(fCheckbox7));
		float fSlow44 = (0.00100000005f * float(fVslider15));
		float fSlow45 = (0.00100000005f * float(fEntry21));
		float fSlow46 = (0.00100000005f * float(fEntry22));
		float fSlow47 = (0.00100000005f * float(fEntry23));
		float fSlow48 = (0.00100000005f * float(fVslider16));
		float fSlow49 = (1.0f - float(fCheckbox8));
		float fSlow50 = (0.00100000005f * float(fVslider17));
		float fSlow51 = (0.00100000005f * float(fEntry24));
		float fSlow52 = (0.00100000005f * float(fEntry25));
		float fSlow53 = (0.00100000005f * float(fEntry26));
		float fSlow54 = (0.00100000005f * float(fVslider18));
		float fSlow55 = (1.0f - float(fCheckbox9));
		float fSlow56 = (0.00100000005f * float(fVslider19));
		float fSlow57 = (0.00100000005f * float(fEntry27));
		float fSlow58 = (0.00100000005f * float(fEntry28));
		float fSlow59 = (0.00100000005f * float(fEntry29));
		float fSlow60 = (0.00100000005f * float(fVslider20));
		float fSlow61 = (1.0f - float(fCheckbox10));
		float fSlow62 = (0.00100000005f * float(fVslider21));
		float fSlow63 = (0.00100000005f * float(fEntry30));
		float fSlow64 = (0.00100000005f * float(fEntry31));
		float fSlow65 = (0.00100000005f * float(fEntry32));
		float fSlow66 = (0.00100000005f * float(fVslider22));
		float fSlow67 = (1.0f - float(fCheckbox11));
		float fSlow68 = (0.00100000005f * float(fVslider23));
		float fSlow69 = (0.00100000005f * float(fEntry33));
		float fSlow70 = (0.00100000005f * float(fEntry34));
		float fSlow71 = (0.00100000005f * float(fEntry35));
		float fSlow72 = (0.00100000005f * float(fVslider24));
		float fSlow73 = (1.0f - float(fCheckbox12));
		float fSlow74 = (0.00100000005f * float(fVslider25));
		float fSlow75 = (0.00100000005f * float(fEntry36));
		float fSlow76 = (0.00100000005f * float(fEntry37));
		float fSlow77 = (0.00100000005f * float(fEntry38));
		float fSlow78 = (0.00100000005f * float(fVslider26));
		float fSlow79 = (1.0f - float(fCheckbox13));
		float fSlow80 = (0.00100000005f * float(fVslider27));
		float fSlow81 = (0.00100000005f * float(fEntry39));
		float fSlow82 = (0.00100000005f * float(fEntry40));
		float fSlow83 = (0.00100000005f * float(fEntry41));
		float fSlow84 = (0.00100000005f * float(fVslider28));
		float fSlow85 = (1.0f - float(fCheckbox14));
		float fSlow86 = (0.00100000005f * float(fVslider29));
		float fSlow87 = (0.00100000005f * float(fEntry42));
		float fSlow88 = (0.00100000005f * float(fEntry43));
		float fSlow89 = (0.00100000005f * float(fEntry44));
		float fSlow90 = (0.00100000005f * float(fVslider30));
		float fSlow91 = (1.0f - float(fCheckbox15));
		float fSlow92 = (0.00100000005f * float(fVslider31));
		float fSlow93 = (0.00100000005f * float(fEntry45));
		float fSlow94 = (0.00100000005f * float(fEntry46));
		float fSlow95 = (0.00100000005f * float(fEntry47));
		float fSlow96 = (0.00100000005f * float(fVslider32));
		float fSlow97 = (0.00100000005f * float(fVslider33));
		float fSlow98 = (0.00100000005f * float(fVslider34));
		float fSlow99 = (0.00100000005f * float(fVslider35));
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fVec1[0] = fTemp2;
			float fTemp3 = (fRec4[1] + (fConst2 * fVec1[1]));
			...
			float fTemp12 = (((fTemp10 + 1.84775901f) / fTemp9) + 1.0f);
			fRec3[0] = ((fConst1 * ((fTemp5 - (fVec3[((IOTA - iTemp7) & 4095)] * (fTemp8 + (1.0f - fTemp6)))) - ((fTemp6 - fTemp8) * fVec3[((IOTA - (iTemp7 + 1)) & 4095)]))) - (((fRec3[2] * (((fTemp10 + -1.84775901f) / fTemp9) + 1.0f)) + (2.0f * (fRec3[1] * fTemp11))) / fTemp12));
			float fTemp13 = (((fTemp10 + 0.765366852f) / fTemp9) + 1.0f);
			fRec2[0] = (((fRec3[2] + (fRec3[0] + (2.0f * fRec3[1]))) / fTemp12) - (((fRec2[2] * (((fTemp10 + -0.765366852f) / fTemp9) + 1.0f)) + (2.0f * (fTemp11 * fRec2[1]))) / fTemp13));
			float fTemp14 = (fRec2[2] + (fRec2[0] + (2.0f * fRec2[1])));
			...
			fRec15[0] = (fSlow12 + (0.999000013f * fRec15[1]));
			float fTemp23 = std::tan((fConst3 * fRec15[0]));
			float fTemp24 = (1.0f / fTemp23);
			float fTemp25 = (1.0f - (1.0f / mydsp_faustpower2_f(fTemp23)));
			float fTemp26 = (((fTemp24 + 1.84775901f) / fTemp23) + 1.0f);
			fRec11[0] = ((fConst1 * ((fTemp19 - (fVec6[((IOTA - iTemp21) & 4095)] * (fTemp22 + (1.0f - fTemp20)))) - ((fTemp20 - fTemp22) * fVec6[((IOTA - (iTemp21 + 1)) & 4095)]))) - (((fRec11[2] * (((fTemp24 + -1.84775901f) / fTemp23) + 1.0f)) + (2.0f * (fRec11[1] * fTemp25))) / fTemp26));
			float fTemp27 = (((fTemp24 + 0.765366852f) / fTemp23) + 1.0f);
			fRec10[0] = (((fRec11[2] + (fRec11[0] + (2.0f * fRec11[1]))) / fTemp26) - (((fRec10[2] * (((fTemp24 + -0.765366852f) / fTemp23) + 1.0f)) + (2.0f * (fTemp25 * fRec10[1]))) / fTemp27));
			float fTemp28 = (fRec10[2] + (fRec10[0] + (2.0f * fRec10[1])));
			...
			fVec7[0] = fTemp30;
			float fTemp31 = (fRec20[1] + (fConst2 * fVec7[1]));
			fRec20[0] = (fTemp31 - std::floor(fTemp31));
			float fTemp32 = mydsp_faustpower2_f(((2.0f * fRec20[0]) + -1.0f));
			fVec8[0] = fTemp32;
			float fTemp33 = ((fTemp0 * (fTemp32 - fVec8[1])) / fTemp30);
			fVec9[(IOTA & 4095)] = fTemp33;
			...
			fRec23[0] = (fSlow18 + (0.999000013f * fRec23[1]));
			float fTemp37 = std::tan((fConst3 * fRec23[0]));
			float fTemp38 = (1.0f / fTemp37);
			float fTemp39 = (1.0f - (1.0f / mydsp_faustpower2_f(fTemp37)));
			float fTemp40 = (((fTemp38 + 1.84775901f) / fTemp37) + 1.0f);
			fRec19[0] = ((fConst1 * ((fTemp33 - (fVec9[((IOTA - iTemp35) & 4095)] * (fTemp36 + (1.0f - fTemp34)))) - ((fTemp34 - fTemp36) * fVec9[((IOTA - (iTemp35 + 1)) & 4095)]))) - (((fRec19[2] * (((fTemp38 + -1.84775901f) / fTemp37) + 1.0f)) + (2.0f * (fRec19[1] * fTemp39))) / fTemp40));
			float fTemp41 = (((fTemp38 + 0.765366852f) / fTemp37) + 1.0f);
			fRec18[0] = (((fRec19[2] + (fRec19[0] + (2.0f * fRec19[1]))) / fTemp40) - (((fRec18[2] * (((fTemp38 + -0.765366852f) / fTemp37) + 1.0f)) + (2.0f * (fTemp39 * fRec18[1]))) / fTemp41));
			float fTemp42 = (fRec18[2] + (fRec18[0] + (2.0f * fRec18[1])));
			fRec24[0] = (fSlow20 + (0.999000013f * fRec24[1]));
			fRec25[0] = (fSlow21 + (0.999000013f * fRec25[1]));
			...
			fVec10[0] = fTemp44;
			float fTemp45 = (fRec28[1] + (fConst2 * fVec10[1]));
			fRec28[0] = (fTemp45 - std::floor(fTemp45));
			float fTemp46 = mydsp_faustpower2_f(((2.0f * fRec28[0]) + -1.0f));
			fVec11[0] = fTemp46;
			float fTemp47 = ((fTemp0 * (fTemp46 - fVec11[1])) / fTemp44);
			fVec12[(IOTA & 4095)] = fTemp47;
			...
			fRec31[0] = (fSlow24 + (0.999000013f * fRec31[1]));
			float fTemp51 = std::tan((fConst3 * fRec31[0]));
			float fTemp52 = (1.0f / fTemp51);
			float fTemp53 = (1.0f - (1.0f / mydsp_faustpower2_f(fTemp51)));
			float fTemp54 = (((fTemp52 + 1.84775901f) / fTemp51) + 1.0f);
			fRec27[0] = ((fConst1 * ((fTemp47 - (fVec12[((IOTA - iTemp49) & 4095)] * (fTemp50 + (1.0f - fTemp48)))) - ((fTemp48 - fTemp50) * fVec12[((IOTA - (iTemp49 + 1)) & 4095)]))) - (((fRec27[2] * (((fTemp52 + -1.84775901f) / fTemp51) + 1.0f)) + (2.0f * (fRec27[1] * fTemp53))) / fTemp54));
			float fTemp55 = (((fTemp52 + 0.765366852f) / fTemp51) + 1.0f);
			fRec26[0] = (((fRec27[2] + (fRec27[0] + (2.0f * fRec27[1]))) / fTemp54) - (((fRec26[2] * (((fTemp52 + -0.765366852f) / fTemp51) + 1.0f)) + (2.0f * (fTemp53 * fRec26[1]))) / fTemp55));
			float fTemp56 = (fRec26[2] + (fRec26[0] + (2.0f * fRec26[1])));
			fRec32[0] = (fSlow26 + (0.999000013f * fRec32[1]));
			fRec33[0] = (fSlow27 + (0.999000013f * fRec33[1]));
			...
			fVec13[0] = fTemp58;
			float fTemp59 = (fRec36[1] + (fConst2 * fVec13[1]));
			fRec36[0] = (fTemp59 - std::floor(fTemp59));
			float fTemp60 = mydsp_faustpower2_f(((2.0f * fRec36[0]) + -1.0f));
			fVec14[0] = fTemp60;
			float fTemp61 = ((fTemp0 * (fTemp60 - fVec14[1])) / fTemp58);
			fVec15[(IOTA & 4095)] = fTemp61;
			...
			fRec39[0] = (fSlow30 + (0.999000013f * fRec39[1]));
			float fTemp65 = std::tan((fConst3 * fRec39[0]));
			float fTemp66 = (1.0f / fTemp65);
			float fTemp67 = (1.0f - (1.0f / mydsp_faustpower2_f(fTemp65)));
			float fTemp68 = (((fTemp66 + 1.84775901f) / fTemp65) + 1.0f);
			fRec35[0] = ((fConst1 * ((fTemp61 - (fVec15[((IOTA - iTemp63) & 4095)] * (fTemp64 + (1.0f - fTemp62)))) - ((fTemp62 - fTemp64) * fVec15[((IOTA - (iTemp63 + 1)) & 4095)]))) - (((fRec35[2] * (((fTemp66 + -1.84775901f) / fTemp65) + 1.0f)) + (2.0f * (fRec35[1] * fTemp67))) / fTemp68));
			float fTemp69 = (((fTemp66 + 0.765366852f) / fTemp65) + 1.0f);
			fRec34[0] = (((fRec35[2] + (fRec35[0] + (2.0f * fRec35[1]))) / fTemp68) - (((fRec34[2] * (((fTemp66 + -0.765366852f) / fTemp65) + 1.0f)) + (2.0f * (fTemp67 * fRec34[1]))) / fTemp69));
			float fTemp70 = (fRec34[2] + (fRec34[0] + (2.0f * fRec34[1])));
			fRec40[0] = (fSlow32 + (0.999000013f * fRec40[1]));
			fRec41[0] = (fSlow33 + (0.999000013f * fRec41[1]));
			...
			fVec16[0] = fTemp72;
			float fTemp73 = (fRec44[1] + (fConst2 * fVec16[1]));
			fRec44[0] = (fTemp73 - std::floor(fTemp73));
			float fTemp74 = mydsp_faustpower2_f(((2.0f * fRec44[0]) + -1.0f));
			fVec17[0] = fTemp74;
			float fTemp75 = ((fTemp0 * (fTemp74 - fVec17[1])) / fTemp72);
			fVec18[(IOTA & 4095)] = fTemp75;
			...
			fRec47[0] = (fSlow36 + (0.999000013f * fRec47[1]));
			float fTemp79 = std::tan((fConst3 * fRec47[0]));
			float fTemp80 = (1.0f / fTemp79);
			float fTemp81 = (1.0f - (1.0f / mydsp_faustpower2_f(fTemp79)));
			float fTemp82 = (((fTemp80 + 1.84775901f) / fTemp79) + 1.0f);
			fRec43[0] = ((fConst1 * ((fTemp75 - (fVec18[((IOTA - iTemp77) & 4095)] * (fTemp78 + (1.0f - fTemp76)))) - ((fTemp76 - fTemp78) * fVec18[((IOTA - (iTemp77 + 1)) & 4095)]))) - (((fRec43[2] * (((fTemp80 + -1.84775901f) / fTemp79) + 1.0f)) + (2.0f * (fRec43[1] * fTemp81))) / fTemp82));
			float fTemp83 = (((fTemp80 + 0.765366852f) / fTemp79) + 1.0f);
			fRec42[0] = (((fRec43[2] + (fRec43[0] + (2.0f * fRec43[1]))) / fTemp82) - (((fRec42[2] * (((fTemp80 + -0.765366852f) / fTemp79) + 1.0f)) + (2.0f * (fTemp81 * fRec42[1]))) / fTemp83));
			float fTemp84 = (fRec42[2] + (fRec42[0] + (2.0f * fRec42[1])));
			fRec48[0] = (fSlow38 + (0.999000013f * fRec48[1]));
			fRec49[0] = (fSlow39 + (0.999000013f * fRec49[1]));
			...
			fRec55[0] = (fSlow42 + (0.999000013f * fRec55[1]));
			float fTemp93 = std::tan((fConst3 * fRec55[0]));
			float fTemp94 = (1.0f / fTemp93);
			float fTemp95 = (1.0f - (1.0f / mydsp_faustpower2_f(fTemp93)));
			float fTemp96 = (((fTemp94 + 1.84775901f) / fTemp93) + 1.0f);
			fRec51[0] = ((fConst1 * ((fTemp89 - (fVec21[((IOTA - iTemp91) & 4095)] * (fTemp92 + (1.0f - fTemp90)))) - ((fTemp90 - fTemp92) * fVec21[((IOTA - (iTemp91 + 1)) & 4095)]))) - (((fRec51[2] * (((fTemp94 + -1.84775901f) / fTemp93) + 1.0f)) + (2.0f * (fRec51[1] * fTemp95))) / fTemp96));
			float fTemp97 = (((fTemp94 + 0.765366852f) / fTemp93) + 1.0f);
			fRec50[0] = (((fRec51[2] + (fRec51[0] + (2.0f * fRec51[1]))) / fTemp96) - (((fRec50[2] * (((fTemp94 + -0.765366852f) / fTemp93) + 1.0f)) + (2.0f * (fTemp95 * fRec50[1]))) / fTemp97));
			float fTemp98 = (fRec50[2] + (fRec50[0] + (2.0f * fRec50[1])));
			fRec56[0] = (fSlow44 + (0.999000013f * fRec56[1]));
			fRec57[0] = (fSlow45 + (0.999000013f * fRec57[1]));
			...
			fVec22[0] = fTemp100;
			float fTemp101 = (fRec60[1] + (fConst2 * fVec22[1]));
			fRec60[0] = (fTemp101 - std::floor(fTemp101));
			float fTemp102 = mydsp_faustpower2_f(((2.0f * fRec60[0]) + -1.0f));
			fVec23[0] = fTemp102;
			float fTemp103 = ((fTemp0 * (fTemp102 - fVec23[1])) / fTemp100);
			fVec24[(IOTA & 4095)] = fTemp103;
			...
			fRec63[0] = (fSlow48 + (0.999000013f * fRec63[1]));
			float fTemp107 = std::tan((fConst3 * fRec63[0]));
			float fTemp108 = (1.0f / fTemp107);
			float fTemp109 = (1.0f - (1.0f / mydsp_faustpower2_f(fTemp107)));
			float fTemp110 = (((fTemp108 + 1.84775901f) / fTemp107) + 1.0f);
			fRec59[0] = ((fConst1 * ((fTemp103 - (fVec24[((IOTA - iTemp105) & 4095)] * (fTemp106 + (1.0f - fTemp104)))) - ((fTemp104 - fTemp106) * fVec24[((IOTA - (iTemp105 + 1)) & 4095)]))) - (((fRec59[2] * (((fTemp108 + -1.84775901f) / fTemp107) + 1.0f)) + (2.0f * (fRec59[1] * fTemp109))) / fTemp110));
			float fTemp111 = (((fTemp108 + 0.765366852f) / fTemp107) + 1.0f);
			fRec58[0] = (((fRec59[2] + (fRec59[0] + (2.0f * fRec59[1]))) / fTemp110) - (((fRec58[2] * (((fTemp108 + -0.765366852f) / fTemp107) + 1.0f)) + (2.0f * (fTemp109 * fRec58[1]))) / fTemp111));
			float fTemp112 = (fRec58[2] + (fRec58[0] + (2.0f * fRec58[1])));
			fRec64[0] = (fSlow50 + (0.999000013f * fRec64[1]));
			fRec65[0] = (fSlow51 + (0.999000013f * fRec65[1]));
			fRec69[0] = (fSlow52 + (0.999000013f * fRec69[1]));
			float fTemp113 = std::max<float>(fRec69[0], 23.4489498f);
			float fTemp114 = std::max<float>(20.0f, std::fabs(fTemp113));
			fVec25[0] = fTemp114;
			float fTemp115 = (fRec68[1] + (fConst2 * fVec25[1]));
			fRec68[0] = (fTemp115 - std::floor(fTemp115));
			float fTemp116 = mydsp_faustpower2_f(((2.0f * fRec68[0]) + -1.0f));
			fVec26[0] = fTemp116;
			float fTemp117 = ((fTemp0 * (fTemp116 - fVec26[1])) / fTemp114);
			fVec27[(IOTA & 4095)] = fTemp117;
			fRec70[0] = (fSlow53 + (0.999000013f * fRec70[1]));
			...
			fRec71[0] = (fSlow54 + (0.999000013f * fRec71[1]));
			float fTemp121 = std::tan((fConst3 * fRec71[0]));
			float fTemp122 = (1.0f / fTemp121);
			float fTemp123 = (1.0f - (1.0f / mydsp_faustpower2_f(fTemp121)));
			float fTemp124 = (((fTemp122 + 1.84775901f) / fTemp121) + 1.0f);
			fRec67[0] = ((fConst1 * ((fTemp117 - (fVec27[((IOTA - iTemp119) & 4095)] * (fTemp120 + (1.0f - fTemp118)))) - ((fTemp118 - fTemp120) * fVec27[((IOTA - (iTemp119 + 1)) & 4095)]))) - (((fRec67[2] * (((fTemp122 + -1.84775901f) / fTemp121) + 1.0f)) + (2.0f * (fRec67[1] * fTemp123))) / fTemp124));
			float fTemp125 = (((fTemp122 + 0.765366852f) / fTemp121) + 1.0f);
			fRec66[0] = (((fRec67[2] + (fRec67[0] + (2.0f * fRec67[1]))) / fTemp124) - (((fRec66[2] * (((fTemp122 + -0.765366852f) / fTemp121) + 1.0f)) + (2.0f * (fTemp123 * fRec66[1]))) / fTemp125));
			float fTemp126 = (fRec66[2] + (fRec66[0] + (2.0f * fRec66[1])));
			fRec72[0] = (fSlow56 + (0.999000013f * fRec72[1]));
			fRec73[0] = (fSlow57 + (0.999000013f * fRec73[1]));
			fRec77[0] = (fSlow58 + (0.999000013f * fRec77[1]));
			float fTemp127 = std::max<float>(fRec77[0], 23.4489498f);
			float fTemp128 = std::max<float>(20.0f, std::fabs(fTemp127));
			fVec28[0] = fTemp128;
			float fTemp129 = (fRec76[1] + (fConst2 * fVec28[1]));
			fRec76[0] = (fTemp129 - std::floor(fTemp129));
			float fTemp130 = mydsp_faustpower2_f(((2.0f * fRec76[0]) + -1.0f));
			fVec29[0] = fTemp130;
			float fTemp131 = ((fTemp0 * (fTemp130 - fVec29[1])) / fTemp128);
			fVec30[(IOTA & 4095)] = fTemp131;
			fRec78[0] = (fSlow59 + (0.999000013f * fRec78[1]));
			...
			fRec79[0] = (fSlow60 + (0.999000013f * fRec79[1]));
			float fTemp135 = std::tan((fConst3 * fRec79[0]));
			float fTemp136 = (1.0f / fTemp135);
			float fTemp137 = (1.0f - (1.0f / mydsp_faustpower2_f(fTemp135)));
			float fTemp138 = (((fTemp136 + 1.84775901f) / fTemp135) + 1.0f);
			fRec75[0] = ((fConst1 * ((fTemp131 - (fVec30[((IOTA - iTemp133) & 4095)] * (fTemp134 + (1.0f - fTemp132)))) - ((fTemp132 - fTemp134) * fVec30[((IOTA - (iTemp133 + 1)) & 4095)]))) - (((fRec75[2] * (((fTemp136 + -1.84775901f) / fTemp135) + 1.0f)) + (2.0f * (fRec75[1] * fTemp137))) / fTemp138));
			float fTemp139 = (((fTemp136 + 0.765366852f) / fTemp135) + 1.0f);
			fRec74[0] = (((fRec75[2] + (fRec75[0] + (2.0f * fRec75[1]))) / fTemp138) - (((fRec74[2] * (((fTemp136 + -0.765366852f) / fTemp135) + 1.0f)) + (2.0f * (fTemp137 * fRec74[1]))) / fTemp139));
			float fTemp140 = (fRec74[2] + (fRec74[0] + (2.0f * fRec74[1])));
			fRec80[0] = (fSlow62 + (0.999000013f * fRec80[1]));
			fRec81[0] = (fSlow63 + (0.999000013f * fRec81[1]));
			fRec85[0] = (fSlow64 + (0.999000013f * fRec85[1]));
			float fTemp141 = std::max<float>(fRec85[0], 23.4489498f);
			float fTemp142 = std::max<float>(20.0f, std::fabs(fTemp141));
			fVec31[0] = fTemp142;
			float fTemp143 = (fRec84[1] + (fConst2 * fVec31[1]));
			fRec84[0] = (fTemp143 - std::floor(fTemp143));
			float fTemp144 = mydsp_faustpower2_f(((2.0f * fRec84[0]) + -1.0f));
			fVec32[0] = fTemp144;
			float fTemp145 = ((fTemp0 * (fTemp144 - fVec32[1])) / fTemp142);
			fVec33[(IOTA & 4095)] = fTemp145;
			fRec86[0] = (fSlow65 + (0.999000013f * fRec86[1]));
			...
			fRec87[0] = (fSlow66 + (0.999000013f * fRec87[1]));
			float fTemp149 = std::tan((fConst3 * fRec87[0]));
			float fTemp150 = (1.0f / fTemp149);
			float fTemp151 = (1.0f - (1.0f / mydsp_faustpower2_f(fTemp149)));
			float fTemp152 = (((fTemp150 + 1.84775901f) / fTemp149) + 1.0f);
			fRec83[0] = ((fConst1 * ((fTemp145 - (fVec33[((IOTA - iTemp147) & 4095)] * (fTemp148 + (1.0f - fTemp146)))) - ((fTemp146 - fTemp148) * fVec33[((IOTA - (iTemp147 + 1)) & 4095)]))) - (((fRec83[2] * (((fTemp150 + -1.84775901f) / fTemp149) + 1.0f)) + (2.0f * (fRec83[1] * fTemp151))) / fTemp152));
			float fTemp153 = (((fTemp150 + 0.765366852f) / fTemp149) + 1.0f);
			fRec82[0] = (((fRec83[2] + (fRec83[0] + (2.0f * fRec83[1]))) / fTemp152) - (((fRec82[2] * (((fTemp150 + -0.765366852f) / fTemp149) + 1.0f)) + (2.0f * (fTemp151 * fRec82[1]))) / fTemp153));
			float fTemp154 = (fRec82[2] + (fRec82[0] + (2.0f * fRec82[1])));
			fRec88[0] = (fSlow68 + (0.999000013f * fRec88[1]));
			fRec89[0] = (fSlow69 + (0.999000013f * fRec89[1]));
			fRec93[0] = (fSlow70 + (0.999000013f * fRec93[1]));
			float fTemp155 = std::max<float>(fRec93[0], 23.4489498f);
			float fTemp156 = std::max<float>(20.0f, std::fabs(fTemp155));
			fVec34[0] = fTemp156;
			float fTemp157 = (fRec92[1] + (fConst2 * fVec34[1]));
			fRec92[0] = (fTemp157 - std::floor(fTemp157));
			float fTemp158 = mydsp_faustpower2_f(((2.0f * fRec92[0]) + -1.0f));
			fVec35[0] = fTemp158;
			float fTemp159 = ((fTemp0 * (fTemp158 - fVec35[1])) / fTemp156);
			fVec36[(IOTA & 4095)] = fTemp159;
			fRec94[0] = (fSlow71 + (0.999000013f * fRec94[1]));
			...
			fRec95[0] = (fSlow72 + (0.999000013f * fRec95[1]));
			float fTemp163 = std::tan((fConst3 * fRec95[0]));
			float fTemp164 = (1.0f / fTemp163);
			float fTemp165 = (1.0f - (1.0f / mydsp_faustpower2_f(fTemp163)));
			float fTemp166 = (((fTemp164 + 1.84775901f) / fTemp163) + 1.0f);
			fRec91[0] = ((fConst1 * ((fTemp159 - (fVec36[((IOTA - iTemp161) & 4095)] * (fTemp162 + (1.0f - fTemp160)))) - ((fTemp160 - fTemp162) * fVec36[((IOTA - (iTemp161 + 1)) & 4095)]))) - (((fRec91[2] * (((fTemp164 + -1.84775901f) / fTemp163) + 1.0f)) + (2.0f * (fRec91[1] * fTemp165))) / fTemp166));
			float fTemp167 = (((fTemp164 + 0.765366852f) / fTemp163) + 1.0f);
			fRec90[0] = (((fRec91[2] + (fRec91[0] + (2.0f * fRec91[1]))) / fTemp166) - (((fRec90[2] * (((fTemp164 + -0.765366852f) / fTemp163) + 1.0f)) + (2.0f * (fTemp165 * fRec90[1]))) / fTemp167));
			float fTemp168 = (fRec90[2] + (fRec90[0] + (2.0f * fRec90[1])));
			fRec96[0] = (fSlow74 + (0.999000013f * fRec96[1]));
			fRec97[0] = (fSlow75 + (0.999000013f * fRec97[1]));
			fRec101[0] = (fSlow76 + (0.999000013f * fRec101[1]));
			float fTemp169 = std::max<float>(fRec101[0], 23.4489498f);
			float fTemp170 = std::max<float>(20.0f, std::fabs(fTemp169));
			fVec37[0] = fTemp170;
			float fTemp171 = (fRec100[1] + (fConst2 * fVec37[1]));
			fRec100[0] = (fTemp171 - std::floor(fTemp171));
			float fTemp172 = mydsp_faustpower2_f(((2.0f * fRec100[0]) + -1.0f));
			fVec38[0] = fTemp172;
			float fTemp173 = ((fTemp0 * (fTemp172 - fVec38[1])) / fTemp170);
			fVec39[(IOTA & 4095)] = fTemp173;
			fRec102[0] = (fSlow77 + (0.999000013f * fRec102[1]));
			...
			fRec103[0] = (fSlow78 + (0.999000013f * fRec103[1]));
			...
			float fTemp180 = (((fTemp178 + 1.84775901f) / fTemp177) + 1.0f);
			fRec99[0] = ((fConst1 * ((fTemp173 - (fVec39[((IOTA - iTemp175) & 4095)] * (fTemp176 + (1.0f - fTemp174)))) - ((fTemp174 - fTemp176) * fVec39[((IOTA - (iTemp175 + 1)) & 4095)]))) - (((fRec99[2] * (((fTemp178 + -1.84775901f) / fTemp177) + 1.0f)) + (2.0f * (fRec99[1] * fTemp179))) / fTemp180));
			float fTemp181 = (((fTemp178 + 0.765366852f) / fTemp177) + 1.0f);
			fRec98[0] = (((fRec99[2] + (fRec99[0] + (2.0f * fRec99[1]))) / fTemp180) - (((fRec98[2] * (((fTemp178 + -0.765366852f) / fTemp177) + 1.0f)) + (2.0f * (fTemp179 * fRec98[1]))) / fTemp181));
			float fTemp182 = (fRec98[2] + (fRec98[0] + (2.0f * fRec98[1])));
			fRec104[0] = (fSlow80 + (0.999000013f * fRec104[1]));
			fRec105[0] = (fSlow81 + (0.999000013f * fRec105[1]));
			fRec109[0] = (fSlow82 + (0.999000013f * fRec109[1]));
			float fTemp183 = std::max<float>(fRec109[0], 23.4489498f);
			float fTemp184 = std::max<float>(20.0f, std::fabs(fTemp183));
			fVec40[0] = fTemp184;
			float fTemp185 = (fRec108[1] + (fConst2 * fVec40[1]));
			fRec108[0] = (fTemp185 - std::floor(fTemp185));
			float fTemp186 = mydsp_faustpower2_f(((2.0f * fRec108[0]) + -1.0f));
			fVec41[0] = fTemp186;
			float fTemp187 = ((fTemp0 * (fTemp186 - fVec41[1])) / fTemp184);
			fVec42[(IOTA & 4095)] = fTemp187;
			fRec110[0] = (fSlow83 + (0.999000013f * fRec110[1]));
			...
			fRec111[0] = (fSlow84 + (0.999000013f * fRec111[1]));
			...
			float fTemp194 = (((fTemp192 + 1.84775901f) / fTemp191) + 1.0f);
			fRec107[0] = ((fConst1 * ((fTemp187 - (fVec42[((IOTA - iTemp189) & 4095)] * (fTemp190 + (1.0f - fTemp188)))) - ((fTemp188 - fTemp190) * fVec42[((IOTA - (iTemp189 + 1)) & 4095)]))) - (((fRec107[2] * (((fTemp192 + -1.84775901f) / fTemp191) + 1.0f)) + (2.0f * (fRec107[1] * fTemp193))) / fTemp194));
			float fTemp195 = (((fTemp192 + 0.765366852f) / fTemp191) + 1.0f);
			fRec106[0] = (((fRec107[2] + (fRec107[0] + (2.0f * fRec107[1]))) / fTemp194) - (((fRec106[2] * (((fTemp192 + -0.765366852f) / fTemp191) + 1.0f)) + (2.0f * (fTemp193 * fRec106[1]))) / fTemp195));
			float fTemp196 = (fRec106[2] + (fRec106[0] + (2.0f * fRec106[1])));
			fRec112[0] = (fSlow86 + (0.999000013f * fRec112[1]));
			fRec113[0] = (fSlow87 + (0.999000013f * fRec113[1]));
			fRec117[0] = (fSlow88 + (0.999000013f * fRec117[1]));
			float fTemp197 = std::max<float>(fRec117[0], 23.4489498f);
			float fTemp198 = std::max<float>(20.0f, std::fabs(fTemp197));
			fVec43[0] = fTemp198;
			float fTemp199 = (fRec116[1] + (fConst2 * fVec43[1]));
			fRec116[0] = (fTemp199 - std::floor(fTemp199));
			float fTemp200 = mydsp_faustpower2_f(((2.0f * fRec116[0]) + -1.0f));
			fVec44[0] = fTemp200;
			float fTemp201 = ((fTemp0 * (fTemp200 - fVec44[1])) / fTemp198);
			fVec45[(IOTA & 4095)] = fTemp201;
			fRec118[0] = (fSlow89 + (0.999000013f * fRec118[1]));
			...
			fRec119[0] = (fSlow90 + (0.999000013f * fRec119[1]));
			...
			float fTemp208 = (((fTemp206 + 1.84775901f) / fTemp205) + 1.0f);
			fRec115[0] = ((fConst1 * ((fTemp201 - (fVec45[((IOTA - iTemp203) & 4095)] * (fTemp204 + (1.0f - fTemp202)))) - ((fTemp202 - fTemp204) * fVec45[((IOTA - (iTemp203 + 1)) & 4095)]))) - (((fRec115[2] * (((fTemp206 + -1.84775901f) / fTemp205) + 1.0f)) + (2.0f * (fRec115[1] * fTemp207))) / fTemp208));
			float fTemp209 = (((fTemp206 + 0.765366852f) / fTemp205) + 1.0f);
			fRec114[0] = (((fRec115[2] + (fRec115[0] + (2.0f * fRec115[1]))) / fTemp208) - (((fRec114[2] * (((fTemp206 + -0.765366852f) / fTemp205) + 1.0f)) + (2.0f * (fTemp207 * fRec114[1]))) / fTemp209));
			float fTemp210 = (fRec114[2] + (fRec114[0] + (2.0f * fRec114[1])));
			fRec120[0] = (fSlow92 + (0.999000013f * fRec120[1]));
			fRec121[0] = (fSlow93 + (0.999000013f * fRec121[1]));
			fRec125[0] = (fSlow94 + (0.999000013f * fRec125[1]));
			float fTemp211 = std::max<float>(fRec125[0], 23.4489498f);
			float fTemp212 = std::max<float>(20.0f, std::fabs(fTemp211));
			fVec46[0] = fTemp212;
			float fTemp213 = (fRec124[1] + (fConst2 * fVec46[1]));
			fRec124[0] = (fTemp213 - std::floor(fTemp213));
			float fTemp214 = mydsp_faustpower2_f(((2.0f * fRec124[0]) + -1.0f));
			fVec47[0] = fTemp214;
			float fTemp215 = ((fTemp0 * (fTemp214 - fVec47[1])) / fTemp212);
			fVec48[(IOTA & 4095)] = fTemp215;
			fRec126[0] = (fSlow95 + (0.999000013f * fRec126[1]));
			...
			fRec127[0] = (fSlow96 + (0.999000013f * fRec127[1]));
			...
			float fTemp222 = (((fTemp220 + 1.84775901f) / fTemp219) + 1.0f);
			fRec123[0] = ((fConst1 * ((fTemp215 - (fVec48[((IOTA - iTemp217) & 4095)] * (fTemp218 + (1.0f - fTemp216)))) - ((fTemp216 - fTemp218) * fVec48[((IOTA - (iTemp217 + 1)) & 4095)]))) - (((fRec123[2] * (((fTemp220 + -1.84775901f) / fTemp219) + 1.0f)) + (2.0f * (fRec123[1] * fTemp221))) / fTemp222));
			float fTemp223 = (((fTemp220 + 0.765366852f) / fTemp219) + 1.0f);
			fRec122[0] = (((fRec123[2] + (fRec123[0] + (2.0f * fRec123[1]))) / fTemp222) - (((fRec122[2] * (((fTemp220 + -0.765366852f) / fTemp219) + 1.0f)) + (2.0f * (fTemp221 * fRec122[1]))) / fTemp223));
			float fTemp224 = (fRec122[2] + (fRec122[0] + (2.0f * fRec122[1])));
			fRec130[0] = (fSlow97 + (0.999000013f * fRec130[1]));
			iRec131[0] = ((1103515245 * iRec131[1]) + 12345);
			fRec133[0] = (fSlow98 + (0.999000013f * fRec133[1]));
			float fTemp225 = (fRec132[1] + (fConst2 * fRec133[1]));
			fRec132[0] = (fTemp225 - std::floor(fTemp225));
			fRec134[0] = (fSlow99 + (0.999000013f * fRec134[1]));
			float fTemp226 = std::tan((fConst3 * fRec134[0]));
			float fTemp227 = (1.0f / fTemp226);
			float fTemp228 = (1.0f - (1.0f / mydsp_faustpower2_f(fTemp226)));
			float fTemp229 = (((fTemp227 + 1.84775901f) / fTemp226) + 1.0f);
			fRec129[0] = ((4.65661287e-10f * ((fRec130[0] * float(iRec131[0])) * ((2.0f * fRec132[0]) + -1.0f))) - (((fRec129[2] * (((fTemp227 + -1.84775901f) / fTemp226) + 1.0f)) + (2.0f * (fRec129[1] * fTemp228))) / fTemp229));
			float fTemp230 = (((fTemp227 + 0.765366852f) / fTemp226) + 1.0f);
			fRec128[0] = (((fRec129[2] + (fRec129[0] + (2.0f * fRec129[1]))) / fTemp229) - (((fRec128[2] * (((fTemp227 + -0.765366852f) / fTemp226) + 1.0f)) + (2.0f * (fTemp228 * fRec128[1]))) / fTemp230));
			float fTemp231 = ((fRec128[2] + (fRec128[0] + (2.0f * fRec128[1]))) / fTemp230);
			output0[i] = FAUSTFLOAT((fSlow0 * ((0.0625f * ((((((((((((((((fSlow1 * (((fRec0[0] * (1.0f - fRec1[0])) * fTemp14) / fTemp13)) + (fSlow7 * (((fRec8[0] * (1.0f - fRec9[0])) * fTemp28) / fTemp27))) + (fSlow13 * (((fRec16[0] * (1.0f - fRec17[0])) * fTemp42) / fTemp41))) + (fSlow19 * (((fRec24[0] * (1.0f - fRec25[0])) * fTemp56) / fTemp55))) + (fSlow25 * (((fRec32[0] * (1.0f - fRec33[0])) * fTemp70) / fTemp69))) + (fSlow31 * (((fRec40[0] * (1.0f - fRec41[0])) * fTemp84) / fTemp83))) + (fSlow37 * (((fRec48[0] * (1.0f - fRec49[0])) * fTemp98) / fTemp97))) + (fSlow43 * (((fRec56[0] * (1.0f - fRec57[0])) * fTemp112) / fTemp111))) + (fSlow49 * (((fRec64[0] * (1.0f - fRec65[0])) * fTemp126) / fTemp125))) + (fSlow55 * (((fRec72[0] * (1.0f - fRec73[0])) * fTemp140) / fTemp139))) + (fSlow61 * (((fRec80[0] * (1.0f - fRec81[0])) * fTemp154) / fTemp153))) + (fSlow67 * (((fRec88[0] * (1.0f - fRec89[0])) * fTemp168) / fTemp167))) + (fSlow73 * (((fRec96[0] * (1.0f - fRec97[0])) * fTemp182) / fTemp181))) + (fSlow79 * (((fRec104[0] * (1.0f - fRec105[0])) * fTemp196) / fTemp195))) + (fSlow85 * (((fRec112[0] * (1.0f - fRec113[0])) * fTemp210) / fTemp209))) + (fSlow91 * (((fRec120[0] * (1.0f - fRec121[0])) * fTemp224) / fTemp223)))) + fTemp231)));
			output1[i] = FAUSTFLOAT((fSlow0 * (fTemp231 + (0.0625f * ((((((((((((((((fSlow1 * (((fRec0[0] * fRec1[0]) * fTemp14) / fTemp13)) + (fSlow7 * (((fRec8[0] * fRec9[0]) * fTemp28) / fTemp27))) + (fSlow13 * (((fRec16[0] * fRec17[0]) * fTemp42) / fTemp41))) + (fSlow19 * (((fRec24[0] * fRec25[0]) * fTemp56) / fTemp55))) + (fSlow25 * (((fRec32[0] * fRec33[0]) * fTemp70) / fTemp69))) + (fSlow31 * (((fRec40[0] * fRec41[0]) * fTemp84) / fTemp83))) + (fSlow37 * (((fRec48[0] * fRec49[0]) * fTemp98) / fTemp97))) + (fSlow43 * (((fRec56[0] * fRec57[0]) * fTemp112) / fTemp111))) + (fSlow49 * (((fRec64[0] * fRec65[0]) * fTemp126) / fTemp125))) + (fSlow55 * (((fRec72[0] * fRec73[0]) * fTemp140) / fTemp139))) + (fSlow61 * (((fRec80[0] * fRec81[0]) * fTemp154) / fTemp153))) + (fSlow67 * (((fRec88[0] * fRec89[0]) * fTemp168) / fTemp167))) + (fSlow73 * (((fRec96[0] * fRec97[0]) * fTemp182) / fTemp181))) + (fSlow79 * (((fRec104[0] * fRec105[0]) * fTemp196) / fTemp195))) + (fSlow85 * (((fRec112[0] * fRec113[0]) * fTemp210) / fTemp209))) + (fSlow91 * (((fRec120[0] * fRec121[0]) * fTemp224) / fTemp223)))))));
			iVec0[1] = iVec0[0];
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec5[1] = fRec5[0];
