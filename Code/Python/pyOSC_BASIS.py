# Script zum Verschicken von OSC-Messages via osc4py3 an das Faust-Programm: "BASIS"
...
data = data[:3, :, :]  # keep the interesting data

'''INFO: Mapping
-   [0] AnzahlFall        = sinus gain
-   [1] AnzahlGenesen     = -
...
params_info = [0, 0, 1]  # type !=0 if parameter needs adjustments in triple-loop
